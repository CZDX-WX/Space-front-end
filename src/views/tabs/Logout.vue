<template>
    <div class="container">
        ...
        <div class="base">
            <button class="activate" :class="{ pushed: activateBtnPushed, active: detonationInProgress }"
                @click="click_activate">
                <span></span>
            </button>
        </div>

        <div class="box" :class="{ opened: coverOpened }" @click="click_cover">
        ...
        <div class="panelClass" :class="{ show: panelVisible }">
            <div class="msg">DEVICE SELF-DESTRUCTION</div>
            <div class="time" :class="{ crono: isCrono }">{{ countdown }}</div>
            <span class="abort" :class="{ hide: isHide }" @click="click_abort">CANCEL</span>
            <span class="detonate" :class="{ show: isShow }">DETONATE</span>
        </div>

        <div class="turn-off" :class="{ close: turnClosed }"></div>
        <div class="closing" :class="{ close: isClosed }"></div>
...
const detonationInProgress = ref(false);
const activateBtnPushed = ref(false);
const panelVisible = ref(false);
const turnClosed = ref(false)
const isClosed = ref(false)
const isCrono = ref(false)
...
const click_cover = () => {
    coverOpened.value = !coverOpened.value
};

function click_activate() {
    activateBtnPushed.value = true;
    setTimeout(function () {
...
.turn-off.close:before,
.turn-off.close:after {
